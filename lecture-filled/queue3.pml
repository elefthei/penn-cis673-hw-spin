...
*/
ltl invariant { 
    [] !(crit[0] && crit[1]) &&        // Mutual exclusion of critical sections (0, 1)
    [] !(crit[0] && crit[2]) &&        // Mutual exclusion of critical sections (0, 2)
    [] !(crit[1] && crit[2]) &&        // Mutual exclusion of critical sections (1, 2)
